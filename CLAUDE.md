...
alcor_star_photometry <input.fits> [-o OUT.csv] [--aperture-radius 4] [--annulus-width 1] [--min-altitude 20] [--vmag-limit 5.5] [--no-refraction] [--sun-alt-max -12] [--check-plot] [--check-radius 680]
...
#   by star name; --check-plot overlays the apertures on the plot_alcor_fits
